...
import { Loader2, LogOutIcon, MoreHorizontal } from 'lucide-react'
...
export default function SidebarAccount({ user }: IProps) {
	...
	return (
		<>
			...
			<Popover>
				<PopoverTrigger className="w-full rounded-full hover:bg-slate-300/10 hidden lg:block cursor-pointer hover:bg-opacity-10 px-4 py-2 transition">
					<div className="flex justify-between items-center gap-2">
						<div className="flex gap-2 items-center">
							...
							<div className="flex flex-col items-start text-white">
								<p className="text-xs">
									{sliceUsers(data?.currentUser?.name, 12)}
								</p>
